...
export type CategoriesBySlugQuery = { category?: { products: Array<{ slug: string, name: string, price: number, images: Array<{ alt: string, url: string }>, categories: Array<{ name: string }> }> } | null };
...
export type CollectionBySlugQuery = { collection?: { products: Array<{ slug: string, name: string, price: number, images: Array<{ alt: string, url: string }>, categories: Array<{ name: string }> }> } | null };
