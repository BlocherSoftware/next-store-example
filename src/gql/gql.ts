 ...
 */
export function graphql(
	source: "query ProductListRelated {\n  products(take: 4, skip: 1) {\n    data {\n      ...ProductListItem\n    }\n  }\n}",
): typeof import("./graphql").ProductListRelatedDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductSearch($search: String!) {\n  products(search: $search) {\n    meta {\n      total\n    }\n    data {\n      ...ProductListItem\n    }\n  }\n}",
): typeof import("./graphql").ProductSearchDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductList($take: Int!, $skip: Int) {\n  products(take: $take, skip: $skip) {\n    meta {\n      count\n      total\n    }\n    data {\n      ...ProductListItem\n    }\n  }\n}",
